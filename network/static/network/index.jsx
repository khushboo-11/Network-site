...
const current_time_update_interval = 50;
...
class CurrentTime extends React.Component {
    ...
    componentDidMount() {
        this.intervalID = setInterval(() => {
            this.setState({ current_time: get_current_time()
            })
                    ...
                    <div className="post-content container">
                        ...
                        <div className="row post-likes no-gutters">
                            <div className="col-auto heart-section">
                               <p onClick={this.like_post.bind(this)}>
                                {this.state.liked ?  "❤": "♡"}
                                </p>
                            </div>
                    ...
                    <div className="post-content container">
                        ...
                        <div className="row post-body">
                            <div className="col-12 post-content-editable">
                                <textarea placeholder="Type away!...." style={fav_color_style}
